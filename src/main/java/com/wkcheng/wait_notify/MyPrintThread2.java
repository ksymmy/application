...
public class MyPrintThread2 {
    ...
    public static class ThreadPrinter2 implements Runnable {
        ...
        private ThreadPrinter2(String name, Object prev, Object self) {
            this.name = name;
            this.prev = prev;
            this.self = self;
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Object b = new Object();
        Object c = new Object();
        ThreadPrinter2 pa = new ThreadPrinter2("A", c, a);
        ThreadPrinter2 pb = new ThreadPrinter2("B", a, b);
        ThreadPrinter2 pc = new ThreadPrinter2("C", b, c);
